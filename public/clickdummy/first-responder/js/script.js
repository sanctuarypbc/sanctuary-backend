...
$(function () {
    ...
    var dd1 = new DropDown($('#assign-survivor'));

    var dd1 = new DropDown($('#assign-survivor-1'));
    var dd1 = new DropDown($('#assign-survivor-2'));
    var dd1 = new DropDown($('#assign-survivor-3'));
    var dd1 = new DropDown($('#assign-survivor-4'));
    var dd1 = new DropDown($('#assign-survivor-5'));
    var dd1 = new DropDown($('#assign-survivor-6'));
    var dd1 = new DropDown($('#assign-survivor-7'));
